...
public class ListarClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblTablaClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RUT_CLIENTE", "NOMBRE", "NUMERO_CELULAR", "DIRECCION", "TIPO_CLIENTE"
            }
        ) {
    ...
    private void cargarTabla(){
        DefaultTableModel modelo = (DefaultTableModel) tblTablaClientes.getModel();
        modelo.setRowCount(0);
        
        for (Cliente i : cc.listarClientes()){
            modelo.addRow(new Object[]{i.getRut(), 
                i.getNombre(), 
